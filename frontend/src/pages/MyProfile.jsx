...
const MyProfile = () => {
  const { userData, setUserData, token, backendUrl,UploadUserProfileData} = useContext(AppContext);
            ...
            {isEdit ? (
              <label htmlFor="image">
                <div className="inline-block relative cursor-pointer">
                  <img className="w-32 h-32 rounded-full opacity-75" src={image ? URL.createObjectURL(image) : ''} alt="" />
                  <img className="w-8 absolute bottom-12 right-10" src={image ? '' : assets.upload_icon} alt="" />
                </div>
